...
"
" As downloaded from
" https://www.vim.org/scripts/script.php?script_id=2045
...
syntax region mipsCharacter start=/'/ end=/'/
...
syntax keyword mipsInstruction add.d add addu addi addiu
...
syntax keyword mipsInstruction ld ldc1 ldl ldr
...
syntax keyword mipsKeyWord eret
syntax keyword mipsKeyWord syscall
syntax keyword mipsKeyWord break
syntax keyword mipsKeyWord nop

hi def link mipsComment        Comment
hi def link mipsNumber         Number
hi def link mipsString         String
hi def link mipsCharacter      Identifier
    " _main: and such
hi def link mipsLabel          Define
    " $a0
hi def link mipsRegister       Statement
"hi def link mipsRegister       Identifier
    " .text and such
hi def link mipsDirective      Function
    " lw and such
hi def link mipsInstruction    Function
hi def link mipsKeyWord        Special
